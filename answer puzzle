...
function openPopup(assignment) {
  ...
  <hr>
  <p style="font-size: 12px">Made by: <a target="_blank" href="goku"></a> on Github | Website: <a target="_blank" href="cum">jh?</a> | Source code: <a target="_blank" href="Mm">https:youtube.com</a></p>
  <p style="font-size: 12px">Licenced under the <a target="_blank" href="htps://github.com/ading2210/edpuzzle-answers/blob/main/LICENS">GNU GPL v3</a>. Do not reupload or redistribute without abiding by those terms.</p>`;
